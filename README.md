...
**Math Magicians**  The Math Magicians website that has a calculator. All data is preserved thanks to the external Math Magicians API service.
...
- You can find the website [here](https://ochiengsteven.github.io/math-magicians/)
...
```sh
  cd my-folder
  git clone git@github.com:Ochiengsteven Math Magicians.git
```
